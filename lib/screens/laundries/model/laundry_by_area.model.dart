...
//
//     final laundryByAreaModel = laundryByAreaModelFromJson(jsonString);

import 'dart:convert';

LaundryByAreaModel laundryByAreaModelFromJson(String str) => LaundryByAreaModel.fromJson(json.decode(str));

String laundryByAreaModelToJson(LaundryByAreaModel data) => json.encode(data.toJson());

class LaundryByAreaModel {
    bool? success;
    String? message;
    List<Datum>? data;
    ...
    factory LaundryByAreaModel.fromJson(Map<String, dynamic> json) => LaundryByAreaModel(
...
class Datum {
    ...
    Datum copyWith({
        ...
        Datum(
            ...
            commercialRegistrationNo: commercialRegistrationNo ?? this.commercialRegistrationNo,
            commercialRegistrationImage: commercialRegistrationImage ?? this.commercialRegistrationImage,
            logo: logo ?? this.logo,
...
class Service {
    ...
    Service copyWith({
        ...
        Service(
            ...
            serviceDescriptionArabic: serviceDescriptionArabic ?? this.serviceDescriptionArabic,
