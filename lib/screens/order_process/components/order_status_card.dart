...
class OrderStatuesCard extends StatelessWidget {
  ...
  final String status;
  final String type;
  final String? firstTripStatus;
  final String? secondTripStatus;
          ...
          children: [
            if (orderType == OrderType.pickup) ...[
              ...
              17.ph
                ...
                firstTripStatus == 'complete' &&
                secondTripStatus == 'incomplete') ...[
              17.ph,
              Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: orderStatuses!
                      .where((e) => e.type == 'delivery-to-customer')
                      .map((e) => (e.status ==
                                      getRoundTripStatus(
                                          orderStatus: OrderStatusesList
                                              .secondTripAssigned) ||
