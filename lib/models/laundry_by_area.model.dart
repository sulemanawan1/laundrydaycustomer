...
LaundryByAreaModel laundryByAreaModelFromJson(String str) =>
    LaundryByAreaModel.fromJson(json.decode(str));

String laundryByAreaModelToJson(LaundryByAreaModel data) =>
...
class LaundryByAreaModel {
  ...
  factory LaundryByAreaModel.fromJson(Map<String, dynamic> json) =>
      LaundryByAreaModel(
