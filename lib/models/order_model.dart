...
class Order {
  ...
  Order copyWith({
    ...
    OrderDeliveries? orderDeliveries,
      ...
      Order(
        ...
        isNotifiedForPickup: isNotifiedForPickup ?? this.isNotifiedForPickup,
  ...
  factory Order.fromJson(Map<String, dynamic> json) => Order(
        ...
        status: json["status"],
        isNotifiedForPickup: json["is_notified_for_pickup"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "recording": recording,
        "status": status,
        "is_notified_for_pickup": isNotifiedForPickup,
...
enum Type { DELIVERY_TO_STORE, PICKUP }

final typeValues = EnumValues(
    {"delivery-to-store": Type.DELIVERY_TO_STORE, "pickup": Type.PICKUP});
